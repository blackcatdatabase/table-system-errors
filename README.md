...
<div style='font-size:13px;opacity:0.92;'>Lineage heat: 1 outbound / 0 inbound · ✅ No engine drift detected · Index coverage: ready · PII: 3 · Changelog: fresh (18 d)</div>
</div>
...
- Pkg folder: [packages\system-errors](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\system-errors)
...
graph LR
  ...
  system_errors["system_errors"]:::center
  system_errors -->|FK| users["users"]:::link
...
## Usage
- Install/upgrade schema: pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package system-errors -Apply
