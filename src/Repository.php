...
final class Repository
{
    ...
    {
        $this->repo = new SystemErrorRepository($db);
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\SystemErrors\Dto\SystemErrorDto|null
    {
        return $this->repo->getByUnique($keys, $asDto);
    }

    /** @return array<string,mixed>|\BlackCat\Database\Packages\SystemErrors\Dto\SystemErrorDto|null */
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\SystemErrors\Dto\SystemErrorDto|null
    {
