...
final class SystemErrorDtoMapper
{
    ...
    /** @var string[] */
    private const NULLABLE    = [ 'id', 'exception_class', 'file', 'line', 'stack_trace', 'token', 'context', 'fingerprint', 'user_id', 'ip_hash', 'ip_hash_key_version', 'ip_text', 'ip_bin', 'user_agent', 'url', 'method', 'http_status', 'resolved_by', 'resolved_at' ];
    ...
    public static function fromRow(array $row): SystemErrorDto {
        ...
        return new SystemErrorDto(...$vals);
    }
