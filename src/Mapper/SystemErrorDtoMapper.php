...
namespace BlackCat\Database\Packages\SystemErrors\Mapper;
...
/**
 * Bidirectional mapper between DB rows and DTO SystemErrorDto:
...
final class SystemErrorDtoMapper
{
    ...
    /** @var string[] */
    private const INT_COLS    = [ 'id', 'line', 'occurrences', 'user_id', 'http_status', 'resolved_by' ];
    /** @var string[] */
     ...
     */
    public static function fromRow(array $row): SystemErrorDto
    {
        /** @var SystemErrorDto */
    ...
    public static function fromRowOrNull(?array $row): ?SystemErrorDto
    {
     ...
     *
     * @param SystemErrorDto   $dto
     * @param string[]|null   $onlyProps  optional whitelist of DTO properties to serialize
     * @return array<string,mixed>
     */
    public static function toRow(SystemErrorDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(SystemErrorDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(SystemErrorDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
     ...
     * @return array<int,SystemErrorDto>
     */
    public static function hydrateList(array $rows): array
    {
        /** @var array<int,SystemErrorDto> */
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(SystemErrorDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,SystemErrorDto>
     */
