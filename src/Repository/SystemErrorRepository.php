...
final class SystemErrorRepository implements RepoContract {
    ...
    public function insert(array $row): void {
        ...
        $tblEsc  = $isMysql ? '`system_errors`' : '"system_errors"';
     ...
     * [ 'fingerprint' ] = unikátní klíče (sloupce) pro konflikty,
     * [ 'level', 'message', 'exception_class', 'file', 'line', 'stack_trace', 'token', 'context', 'occurrences', 'user_id', 'ip_hash', 'ip_hash_key_version', 'ip_text', 'ip_bin', 'user_agent', 'url', 'method', 'http_status', 'resolved', 'resolved_by', 'resolved_at', 'last_seen' ] = které sloupce aktualizovat.
     */
    public function upsert(array $row): void {
        ...
        $keys = [ 'fingerprint' ];
        $upd  = [ 'level', 'message', 'exception_class', 'file', 'line', 'stack_trace', 'token', 'context', 'occurrences', 'user_id', 'ip_hash', 'ip_hash_key_version', 'ip_text', 'ip_bin', 'user_agent', 'url', 'method', 'http_status', 'resolved', 'resolved_by', 'resolved_at', 'last_seen' ];
