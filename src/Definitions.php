...
final class Definitions {
    ...
    public static function uniqueKeys(): array { return [ [ 'fingerprint' ], [ 'id' ] ]; }
    ...
    public static function intColumns(): array { return [ 'id', 'line', 'occurrences', 'user_id', 'http_status', 'resolved_by' ]; }
    ...
    public static function piiColumns(): array { return [ 'token', 'ip_hash' ]; }
