...
final class Criteria extends BaseCriteria
{
    ...
    {
        return [ 'id', 'level', 'message', 'exception_class', 'file', 'line', 'stack_trace', 'token', 'context', 'fingerprint', 'occurrences', 'user_id', 'ip_hash', 'ip_hash_key_version', 'ip_text', 'ip_bin', 'user_agent', 'url', 'method', 'http_status', 'resolved', 'resolved_by', 'resolved_at', 'created_at', 'last_seen' ];
    }
    ...
    {
        $x = [ 'id', 'level', 'message', 'exception_class', 'file', 'line', 'stack_trace', 'token', 'fingerprint', 'occurrences', 'user_id', 'ip_hash_key_version', 'ip_text', 'user_agent', 'url', 'method', 'http_status', 'resolved', 'resolved_by', 'resolved_at', 'created_at', 'last_seen' ];
